...
Interview expensesInterview() => Interview(
      ...
      steps: [
        ...
        _expenseStep('Electricity', ExpenseCategory.utilities),
        _expenseStep('Water & sewer', ExpenseCategory.utilities),
        _expenseStep('Gas & heating', ExpenseCategory.utilities),
        _expenseStep('Internet & cable', ExpenseCategory.utilities),
        _expenseStep('Phone', ExpenseCategory.utilities),
        _expenseStep('Streaming & subscriptions', ExpenseCategory.entertainment),
        _expenseStep('Groceries', ExpenseCategory.food, freq: 'week'),
        _expenseStep('Dining out', ExpenseCategory.food),
